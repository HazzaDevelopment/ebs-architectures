...
public class GraphCreator {
    ...
    public String createStandardGraph(String element, String type, List<String> labels, String labelTitle,List<Double> data) {
        System.out.println("Creating graph for element: " + element);
        System.out.println("Creating graph for type: " + type);
        System.out.println("Creating graph for labels: " + Arrays.toString(labels.toArray()));
        System.out.println("Creating graph for labelTitle: " + labelTitle);
        System.out.println("Creating graph for labelTitle: " + Arrays.toString(data.toArray()));


        String joinedLabels = StringUtils.wrap(StringUtils.join(labels, "\", \""), "\"");
        ...
        String formattedGraph = String.format(graph, element, type, joinedLabels, labelTitle, graphData);
